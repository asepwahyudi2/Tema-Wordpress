...
<article class="single-game single-tutorial">
    <div class="single-game-header">
        <?php if (has_post_thumbnail()) { the_post_thumbnail('game-detail'); } else { echo '<div class="no-thumb single-no-thumb"><i class="fas fa-graduation-cap"></i></div>'; } ?>
